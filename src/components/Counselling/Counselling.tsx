...
<<<<<<< HEAD
            <div className='flex justify-between bg-white px-8 rounded-lg shadow-lg shadow-slate-300 py-4'>
                <div>
                    ...
                    <p className='mt-8 mb-6 font-semibold'>{course?.degree} <span className="text-red-500">/</span> Part-Time <span className="text-red-500">/</span> Blended</p>
                    <div className='flex items-start gap-3'>
                        {/* <Image width="40" height="40" className="w-10 h-10" src={course.photo.logo} alt="logo" /> */}
=======
...
>>>>>>> adb96ef0bd0710c83e607631292c1ee18164eaf3
                        <div>
...
<<<<<<< HEAD
                <div className='grid'>
                    ...
                    <p className=' text-lg font-bold'>{course?.tuitionFee} EUR / year</p>
                    <p className=' ml-20 text-lg font-bold text-left '>{course?.duration} year</p>
